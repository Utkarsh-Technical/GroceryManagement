                                            ...
                                            <div class="card-header-tab card-header">
                                                ...
                                                <div class="col-md-12">
                                                    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav pt-0 pb-3">
                                                        <li class="nav-item">
                                                        <a href='Item.php'>
                                                            <button role="tab" class="btn btn-primary btn-item-tab " >
                                                                <span>My Item</span>
                                                            </button>
                                                            </a>
                                                        </li>
                                                        <a href="Total-Item.php">
                                                            <button class="btn btn-primary btn-item-tab active" >
						 ...
						 <option value="100">100</option>
                                                ...
                                                <table style="width: 100%;" id="table-id"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" id="inputEmail4" value="<?php echo $row["items"]; ?>" name="items" readonly></td>
                                                        
                                                        <td><input type="text" class="form-control" id="inputAddress" value="₹<?php echo $row["price"];?>" name="price">
                                                        </td>
                                                        
                                                        <td><input type="text" class="form-control" id="inputAddress" value="/<?php echo $row["weight"]; ?>" name="weight" readonly></td>
                                                        <td>
                                                         <button  type="submit" class="btn btn-success add-btn" >Add</button></td>
                                                    </tr>

                                                ...
                                                <div class="main-card mb-3 card">
                                                    ...
                                                    <?php 
                                                       $connect= mysqli_connect('database-server.cil0lbnaent8.ap-south-1.rds.amazonaws.com','admin','Dash_Utkarsh','DOT') or die("Failed to Connect with Database ");
                                                        ...
                                                        $sql = "SELECT * FROM Orders where PinCode = $y";
                                                        $result = mysqli_query($connect,$sql) or die("Query Unsuccessful.");
                                                         if(mysqli_num_rows($result)>0){
                                                            while($row = mysqli_fetch_assoc($result)){
                                                    ?>    
                                                            <tr>
                                                                <td class="text-center text-muted"><?php echo $row["Order_id"]; ?></td>
                                                                <td>
                                                                    <div class="widget-content p-0">
                                                                        <div class="widget-content-wrapper">
                                                                            <div class="widget-content-left mr-3">
                                                                            ...
                                                                            <div class="widget-content-left flex2">
                                                                                <div class="widget-heading"> <?php echo $row["C_Name"]; ?> </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="text-center"><?php echo $row["C_Address"]; ?></td>
                                                            ...
                                                            if($row["Product_Status"] == 1)
                                                                    ...
                                                                    echo "<div class='badge badge-info'>Orders Packed</div>";
                                                               ...
                                                               echo "<div class='badge badge-danger'>Orders Shipped</div>";
                                                                ...
                                                                <td class="text-center">
                                                                  <a href='Order_Items.php?id=<?php echo $row["Order_id"] ?>'>  <button type="button" id="PopoverCustomT-1"
